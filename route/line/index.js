...
router.get('/login', (req, res) => {
   ...
   let url = `https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=${line_client_id}&redirect_uri=${line_redirect_uri}&state=12345abcde&scope=profile%20openid&nonce=09876xyz`
   res.redirect(url);
});
